...
const EVENTS_TO_SUB_TO = [
    ...
    "channel.subscribe", //When the sub starts
    "channel.subscription.gift", //When a sub is gifted
    "channel.subscription.message", //resub
    "channel.raid", //Raid
    "channel.cheer", //bits
    "channel.hype_train.begin", //hype train start
    "channel.hype_train.end", //hype train end
    "stream.online", //When stream is online
    "channel.channel_points_custom_reward_redemption.add", // Use of channel points
    "channel.poll.begin",
    ...
    "stream.offline" //When the stream is offline
];
...
module.exports.onEvent = function (data) {
    console.log(data);
};
